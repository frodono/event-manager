...
export class EventService {
  ...
  getEventGuestList(eventId: string): firebase.firestore.CollectionReference {
    return this.eventListRef.doc(eventId).collection('guestList');
  }

  addGuest(guestName: string, eventId: string, eventPrice: number,  guestPicture: string = null): Promise<void> {
    return this.eventListRef
      .doc(eventId)
